...
/**
 * Interfaccia che permette di implementare i DAO della tabella Equipment
 */
public interface DAOEquipment {
     ...
     * @param laboratoryName Nome del laboratorio nel quale e' attualmente utilizzata l'attrezzatura.
