...
public class ProjectListController implements Initializable {
    ...
    @FXML
    private TableColumn<Project, String> ProjectBudgetTable;

    @FXML
    private TableColumn<Project, String> ProjectCupTable;

    @FXML
    private TableColumn<Project, String> ProjectEndDateTable;

    @FXML
    private TableColumn<Project, String> ProjectNameTable;

    @FXML
    private TableColumn<Project, String> ProjectRemainingFundsTable;

    @FXML
    private TableColumn<Project, String> ProjectStartDateTable;
    @FXML
    private TableColumn<Project, String> scientificReferentTable;

    @FXML
    private TableColumn<Project, String> scientificResponsibleTable;
    ...
    @FXML
    private Button dismissProjectButton;
    ...
    @FXML
    void modifyProject(ActionEvent event) {
